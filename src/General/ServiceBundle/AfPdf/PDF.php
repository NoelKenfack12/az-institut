...
/**
    ...
    */
namespace General\ServiceBundle\AfPdf;
...
{
    // Logo
    $this->Image(__DIR__.'/../../../../web/template/images/logoafex.png',3,6,40);
    // Police Arial gras 15
    $this->SetFont('Arial','',9);
	
	$this->Image(__DIR__.'/../../../../web/template/images/ligne2.png',65,38,150);
	
	$this->SetFont('Arial','i',8);
	$this->SetY(0);
	$this->SetX(192);
	$this->Cell(60,10,$this->getDate(),0,1);
	$this->Image(__DIR__.'/../../../../web/template/images/ligneright.png',65,4,150);
    // Saut de ligne
    $this->Ln(5);
}
...
function Footer()
{
	...
	$this->Image(__DIR__.'/../../../../web/template/images/ligneright.png',65,134,150);
}
