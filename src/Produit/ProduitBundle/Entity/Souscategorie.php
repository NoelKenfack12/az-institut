...
class Souscategorie
{
	...
	*/
	...
	/**
         * @ORM\OneToMany(targetEntity="Produit\ServiceBundle\Entity\Service", mappedBy="souscategorie")
         */
    private $services;
	...
	*/
	...
	public function getProduitValide()
	{
		...
		if($this->getEm() != null)
		{
			$liste_produit = $this->getEm()->getRepository('ProduitProduitBundle:Produit')
	...
	{
		$liste_service = $this->em->getRepository('ProduitServiceBundle:Service')
