 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Produit\ProduitBundle\Entity\CorrectionpratiqueRepository")
...
class Correctionpratique
{
	...
	*/
	...
	return 'bundles/produit/produit/correction/tp';
	}
