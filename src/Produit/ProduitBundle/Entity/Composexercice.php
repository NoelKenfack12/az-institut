 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Produit\ProduitBundle\Entity\ComposexerciceRepository")
...
class Composexercice
{
	...
	/**
         * @ORM\ManyToOne(targetEntity="Produit\ProduitBundle\Entity\Exercicepartie")
	...
	*/
     ...
     * Set exercicepartie
     *
     * @param \Produit\ProduitBundle\Entity\Exercicepartie $exercicepartie
     * @return Composexercice
     */
    public function setExercicepartie(\Produit\ProduitBundle\Entity\Exercicepartie $exercicepartie)
    {
     ...
     * Get exercicepartie
     *
     * @return \Produit\ProduitBundle\Entity\Exercicepartie 
     */
    public function getExercicepartie()
    {
