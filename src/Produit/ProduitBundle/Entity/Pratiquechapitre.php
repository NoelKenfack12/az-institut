 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Produit\ProduitBundle\Entity\PratiquechapitreRepository")
...
class Pratiquechapitre
{
	...
	/**
       * @ORM\ManyToOne(targetEntity="Produit\ProduitBundle\Entity\Chapitrecours", inversedBy="pratiquechapitres")
       * @ORM\JoinColumn(nullable=false)
        */
	private $chapitrecours;
	
	/**
       * @ORM\OneToOne(targetEntity="Produit\ProduitBundle\Entity\Correctionpratique", cascade={"persist", "remove"})
      * @Assert\Valid()
       */
	...
	*/
    ...
    /**
     * Set correctionpratique
     *
     * @param \Produit\ProduitBundle\Entity\Correctionpratique $correctionpratique
     * @return Pratiquechapitre
     */
    public function setCorrectionpratique(\Produit\ProduitBundle\Entity\Correctionpratique $correctionpratique = null)
    {
    ...
    /**
     * Get correctionpratique
     *
     * @return \Produit\ProduitBundle\Entity\Correctionpratique 
     */
    public function getCorrectionpratique()
    {
