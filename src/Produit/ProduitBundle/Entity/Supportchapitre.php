 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Produit\ProduitBundle\Entity\SupportchapitreRepository")
 ** @ORM\HasLifecycleCallbacks
 */
 
class Supportchapitre
{
    /**
     * @var integer
     *
	...
	/**
       * @ORM\ManyToOne(targetEntity="Produit\ProduitBundle\Entity\Chapitrecours", inversedBy="supportchapitres")
	...
	*/
	...
	return 'bundles/produit/produit/supports/supportchapitre';
	}
	...
	*/
    ...
    public function setChapitrecours(\Produit\ProduitBundle\Entity\Chapitrecours $chapitrecours)
    {
		...
		$chapitrecours->addSupportchapitre($this);
