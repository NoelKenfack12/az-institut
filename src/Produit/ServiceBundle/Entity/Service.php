...
class Service
{
	...
	/**
       * @ORM\ManyToOne(targetEntity="Produit\ProduitBundle\Entity\Souscategorie", inversedBy="services")
	...
	*@Assert\Valid()
	...
	/**
           * @ORM\OneToOne(targetEntity="Produit\ServiceBundle\Entity\Imgservicesecond",  cascade={"persist","remove"})
           * @ORM\JoinColumn(nullable=true)
	*@Assert\Valid()
          */
	...
	/**
          * @ORM\ManyToMany(targetEntity="Produit\ProduitBundle\Entity\Produit")
	 * @ORM\JoinColumn(nullable=true)
          */
    private $produits;
    ...
    /**
     * Set imgservicesecond
     *
     * @param \Produit\ServiceBundle\Entity\Imgservicesecond $imgservicesecond
     * @return Service
     */
    public function setImgservicesecond(\Produit\ServiceBundle\Entity\Imgservicesecond $imgservicesecond = null)
    {
    ...
    /**
     * Get imgservicesecond
     *
     * @return \Produit\ServiceBundle\Entity\Imgservicesecond 
     */
    public function getImgservicesecond()
    {
