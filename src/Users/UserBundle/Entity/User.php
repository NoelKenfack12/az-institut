...
class User implements UserInterface
{
	...
	/**
         * @ORM\OneToOne(targetEntity="Users\UserBundle\Entity\Imgcouverture", mappedBy="user")
         */
    private $imgcouverture;
	
	/**
          * @ORM\ManyToMany(targetEntity="Produit\ServiceBundle\Entity\Commentaireblog")
	 * @ORM\JoinColumn(nullable=true)
          */
    private $sujetepingles;
	...
	public function __construct(GeneralServicetext $service)
	{
		...
		$this->sujetepingles = new \Doctrine\Common\Collections\ArrayCollection();
	}
     ...
     * Set imgcouverture
     *
     * @param \Users\UserBundle\Entity\Imgcouverture $imgcouverture
     * @return User
     */
    public function setImgcouverture(\Users\UserBundle\Entity\Imgcouverture $imgcouverture = null)
    {
     ...
     * Get imgcouverture
     *
     * @return \Users\UserBundle\Entity\Imgcouverture 
     */
     ...
     * Add sujetepingles
     *
     * @param \Produit\ServiceBundle\Entity\Commentaireblog $sujetepingles
     * @return User
     */
    public function addSujetepingle(\Produit\ServiceBundle\Entity\Commentaireblog $sujetepingles)
    {
        $this->sujetepingles[] = $sujetepingles;

        return $this;
    }

    /**
     * Remove sujetepingles
     *
     * @param \Produit\ServiceBundle\Entity\Commentaireblog $sujetepingles
     */
    public function removeSujetepingle(\Produit\ServiceBundle\Entity\Commentaireblog $sujetepingles)
    {
        $this->sujetepingles->removeElement($sujetepingles);
    }
     ...
     */
    public function getSujetepingles()
    {
        return $this->sujetepingles;
    }
}
