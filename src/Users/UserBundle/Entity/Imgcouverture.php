 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Users\UserBundle\Entity\ImgcouvertureRepository")
...
class Imgcouverture
{
	...
	*/
	...
	/**
       * @ORM\OneToOne(targetEntity="Users\UserBundle\Entity\User", inversedBy="imgcouverture" )
