...
use Users\AdminuserBundle\Entity\Parametreadmin;
use Symfony\Component\HttpFoundation\File\UploadedFile;

class ParametreadminController extends Controller
{
public function parametresadminAction()
{
	$service = $this->container->get('general_service.servicetext');
	$em = $this->getDoctrine()->getManager();
	
	$liste_param = $em->getRepository('UsersAdminuserBundle:Parametreadmin')
	                  ->findAll();
	...
	{
		$oldparam1 = $em->getRepository('UsersAdminuserBundle:Parametreadmin')
		...
		$oldparam2 = $em->getRepository('UsersAdminuserBundle:Parametreadmin')
		...
		$oldparam3 = $em->getRepository('UsersAdminuserBundle:Parametreadmin')
		...
		$oldparam4 = $em->getRepository('UsersAdminuserBundle:Parametreadmin')
		...
		$oldparam6 = $em->getRepository('UsersAdminuserBundle:Parametreadmin')
		...
		$oldparam7 = $em->getRepository('UsersAdminuserBundle:Parametreadmin')
		...
		$oldparam8 = $em->getRepository('UsersAdminuserBundle:Parametreadmin')
		...
		$oldparam9 = $em->getRepository('UsersAdminuserBundle:Parametreadmin')
		...
		$oldparam10 = $em->getRepository('UsersAdminuserBundle:Parametreadmin')
	...
	{ 
		$oldparam = $em->getRepository('UsersAdminuserBundle:Parametreadmin')
	                   ->find($_POST['idparam']);
		if($oldparam != null)
		{
	...
	$liste_param = $em->getRepository('UsersAdminuserBundle:Parametreadmin')
	                  ->myFindAll();
	return $this->render('UsersAdminuserBundle:Parametresadmin:parametresadmin.html.twig',
