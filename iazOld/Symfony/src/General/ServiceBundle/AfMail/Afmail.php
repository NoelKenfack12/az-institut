...
require_once(dirname(__FILE__) . '/QPrintEncoding.php');
require_once(dirname(__FILE__) . '/SevenBitEncoding.php');
require_once(dirname(__FILE__) . '/stringEmbeddedImage.php');
