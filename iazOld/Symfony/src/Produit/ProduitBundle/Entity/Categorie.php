 ...
 * @UniqueEntity(fields="typeservice", message="Cette catégorie existe déjà.")
...
class Categorie
{
     ...
     * @var string
     *
     * @ORM\Column(name="typeservice", type="string", length=255, nullable=true)
     */
    private $typeservice;
	...
	*/
	...
	{
		$liste_scat = $this->em->getRepository('ProduitProduitBundle:Souscategorie')
							   ->findBy(array('categorie'=>$this), array('rang'=>'asc'));
		return $liste_scat;
	}
}
