...
class Souscategorie
{
	...
	*/
	...
	private $categorie;
	 ...
	 /**
       * @ORM\ManyToOne(targetEntity="Produit\ProduitBundle\Entity\Cataloguechantier", inversedBy="souscategories")
    ...
    */
	...
	/**
	 * @ORM\OneToMany(targetEntity="Produit\ProduitBundle\Entity\Caracteristique", mappedBy="souscategorie")
	 */
	...
	*/
     ...
     *
     * @param \Produit\ProduitBundle\Entity\Caracteristique $caracteristiques
     * @return Souscategorie
     */
	...
	{
		$liste_prod = $this->em->getRepository('ProduitProduitBundle:Produit')
     ...
     *
     * @param \Produit\ProduitBundle\Entity\Cataloguechantier $cataloguechantier
     * @return Souscategorie
     */
     ...
     *
     * @return \Produit\ProduitBundle\Entity\Cataloguechantier 
     */
