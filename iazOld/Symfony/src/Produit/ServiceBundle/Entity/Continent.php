 ...
 *
 * @ORM\Table("continent")
 * @ORM\Entity(repositoryClass="Produit\ServiceBundle\Entity\ContinentRepository")
...
class Continent
{
	...
	/**
         * @ORM\OneToMany(targetEntity="Produit\ServiceBundle\Entity\Pays", mappedBy="continent")
         */
    private $pays;
	...
	*/
     ...
     * @return Continent
     */
    public function addPay(\Produit\ServiceBundle\Entity\Pays $pays)
    {
        $this->pays[] = $pays;
     ...
     * @param \Produit\ServiceBundle\Entity\Pays $pays
     */
    public function removePay(\Produit\ServiceBundle\Entity\Pays $pays)
    {
