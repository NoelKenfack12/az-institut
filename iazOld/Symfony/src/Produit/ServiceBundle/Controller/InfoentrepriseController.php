...
public function modifierinfoentrepriseAction(Infoentreprise $info)
{
	...
	$alldetailinfo = $em->getRepository('ProduitServiceBundle:Detailinfoentreprise')
	                      ->findBy(array('infoentreprise'=>$info));
    return $this->render('UsersAdminuserBundle:Infoentreprise:modifierinfoentreprise.html.twig',
	array('form'=>$form->createView(),'alldetailinfo'=>$alldetailinfo,'formsupp'=>$formsupp->createView(),'info'=>$info,'formdetail'=>$formdetail->createView()));
}
