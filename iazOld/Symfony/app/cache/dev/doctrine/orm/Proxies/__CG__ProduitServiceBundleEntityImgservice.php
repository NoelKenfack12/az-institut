 ...
 */
class Imgservice extends \Produit\ServiceBundle\Entity\Imgservice implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Imgservice' . "\0" . 'id', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Imgservice' . "\0" . 'src', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Imgservice' . "\0" . 'alt', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Imgservice' . "\0" . 'file', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Imgservice' . "\0" . 'tempFilename', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Imgservice' . "\0" . 'servicetext');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Imgservice $proxy) {
