 ...
 */
class Imgproduit extends \Produit\ProduitBundle\Entity\Imgproduit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Produit\\ProduitBundle\\Entity\\Imgproduit' . "\0" . 'id', '' . "\0" . 'Produit\\ProduitBundle\\Entity\\Imgproduit' . "\0" . 'src', '' . "\0" . 'Produit\\ProduitBundle\\Entity\\Imgproduit' . "\0" . 'alt', '' . "\0" . 'Produit\\ProduitBundle\\Entity\\Imgproduit' . "\0" . 'date', '' . "\0" . 'Produit\\ProduitBundle\\Entity\\Imgproduit' . "\0" . 'file', '' . "\0" . 'Produit\\ProduitBundle\\Entity\\Imgproduit' . "\0" . 'tempFilename', '' . "\0" . 'Produit\\ProduitBundle\\Entity\\Imgproduit' . "\0" . 'servicetext');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Imgproduit $proxy) {
