 ...
 */
class Yourcv extends \Produit\ServiceBundle\Entity\Yourcv implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Yourcv' . "\0" . 'id', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Yourcv' . "\0" . 'src', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Yourcv' . "\0" . 'nbtele', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Yourcv' . "\0" . 'alt', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Yourcv' . "\0" . 'file', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Yourcv' . "\0" . 'tempFilename', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Yourcv' . "\0" . 'servicetext');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Yourcv $proxy) {
    ...
    public function setNbtele($nbtele)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNbtele', array($nbtele));

        return parent::setNbtele($nbtele);
    }
    ...
    public function getNbtele()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNbtele', array());

        return parent::getNbtele();
    }
