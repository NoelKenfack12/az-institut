 ...
 */
class Typearticle extends \Produit\ServiceBundle\Entity\Typearticle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Typearticle' . "\0" . 'id', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Typearticle' . "\0" . 'nom', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Typearticle' . "\0" . 'description', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Typearticle' . "\0" . 'rang', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Typearticle' . "\0" . 'src', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Typearticle' . "\0" . 'alt', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Typearticle' . "\0" . 'position', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Typearticle' . "\0" . 'date', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Typearticle' . "\0" . 'user', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Typearticle' . "\0" . 'services', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Typearticle' . "\0" . 'file', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Typearticle' . "\0" . 'tempFilename', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Typearticle' . "\0" . 'servicetext', '' . "\0" . 'Produit\\ServiceBundle\\Entity\\Typearticle' . "\0" . 'em');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Typearticle $proxy) {
