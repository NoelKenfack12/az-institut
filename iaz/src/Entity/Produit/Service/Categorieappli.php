...
use App\Repository\Produit\Service\CategorieappliRepository;
 ...
 * @ORM\Entity(repositoryClass=CategorieappliRepository::class)
...
class Categorieappli
{
    ...
    */
	...
	/**
     * @ORM\OneToMany(targetEntity=Application::class, mappedBy="categorieappli")
    */
	...
	*/
     ...
     */
    public function addApplication(Application $applications): self
    {
