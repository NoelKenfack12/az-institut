...
use App\Repository\Produit\Service\ApplicationRepository;
...
class Application
{
	...
	/**
	* @ORM\ManyToOne(targetEntity=Categorieappli::class, inversedBy="applications")
	...
	*/
     ...
     * @return Application
     */
    public function setCategorieappli(Categorieappli $categorieappli): self
    {
     ...
     * Get categorieappli
     */
    public function getCategorieappli(): ?Categorieappli
    {
