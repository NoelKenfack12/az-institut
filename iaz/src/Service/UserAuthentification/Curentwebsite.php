...
class Curentwebsite
{
	...
	protected function displayBeta(Response $reponse)
	{
		...
		$curentsite = null; /*$this->em->getRepository('App\Entity\Produit\Service\Curentwebsite')
		...
		if($curentsite == null)
		{
			...
			<html>
				<head>
					...
					<link rel="shortcut icon" href="http://afhunt.com/Symfony/web/template/images/logo-sm-afh.png">
				</head>
				<body>
					<div id="contenair">
					<div class="row">
