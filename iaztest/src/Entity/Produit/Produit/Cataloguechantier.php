...
use App\Repository\Produit\Produit\CataloguechantierRepository;
...
class Cataloguechantier
{
    ...
    */
	...
	/**
	 * @ORM\OneToMany(targetEntity=Souscategorie::class, mappedBy="cataloguechantier")
	 */
	...
	*/
	...
	{
		$liste_catalogue = $this->em->getRepository(Produit::class)
